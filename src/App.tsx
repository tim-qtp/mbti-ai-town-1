    ...
    <main className="relative flex min-h-screen flex-col items-center justify-between font-body game-">
      ...
      >
        <div className="font-body">
          ...
          <p>
            Ever wondered what would happen if you put AI personalities on an island together? Well,
          ...
          <p>
            Join us in this evolving experiment where AI personalities come to life! Who will become
